function [best_solutions,sorted_prices] = GenerateBestSolutionsCE(params,Team,probabilites)
        all_lotteries = zeros(params.num_of_lotteries,params.team_size);
        for i=1:params.num_of_lotteries
            all_lotteries(i,:) = ProjectMixed.GenerateSolutionCE(params,Team,probabilites);
        end

    curr_prices = ProjectMixed.calc_pricesCE(params,all_lotteries,Team.graph);
